...
<div class="container mx-auto px-4 py-8 py-40 mt-40">
    ...
    <h1 class="text-2xl font-bold text-green-700 mb-6">Sản phẩm của thương hiệu: {{ $brand->name }}</h1>

    <!-- Form lọc giá + danh mục -->
    <form method="GET" action="{{ route('site.by-brand', $brand->slug) }}">
        <div class="flex items-center gap-4 mb-6 flex-wrap">
            ...
            <a href="{{ route('site.product.byBrand', $brand->slug) }}" class="text-blue-500 underline ml-2">Reset</a>
        </div>
    </form>
