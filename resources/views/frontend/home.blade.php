...
<x-layout-site>
    ...
    <main>
        <!--Banner-->
        <div x-data="{ active: 0, showSlider: false }" 
            x-init="setInterval(() => { if (showSlider) active = (active + 1) % 3 }, 3000)" 
            ...
            <div x-show="showSlider" 
                ...
                <div class="flex w-[300%] transition-transform duration-1000 ease-in-out"
                    ...
                    <img src="{{ asset('assets/images/banner1.jpg') }}" class="w-1/3 h-full object-cover flex-shrink-0" alt="banner1">
                    <img src="{{ asset('assets/images/banner2.jpg') }}" class="w-1/3 h-full object-cover flex-shrink-0" alt="banner2">
                    <img src="{{ asset('assets/images/banner3.jpg') }}" class="w-1/3 h-full object-cover flex-shrink-0" alt="banner3">
                </div>
            </div>
