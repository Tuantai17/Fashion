    ...
    <div class="content-wrapper">
        <div class="mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold text-[rgb(246,81,119)]">Danh Sách Đơn Hàng</h2>
                <div class="text-right">
                    <a href="{{ route('order.trash') }}" class="text-[rgb(246,81,119)] px-2 py-2 rounded-xl mx-1 font-semibold hover:text-[rgb(244,8,8)]">
                ...
                <tbody>
                    @foreach ($list as $item)
                        <tr class="hover:bg-gray-100">
                            ...
                            <a href="{{ route('order.show', ['order' => $item->id]) }}" class="text-blue-500">
