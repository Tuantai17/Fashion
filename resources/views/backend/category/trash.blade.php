    ...
    <div class="content-wrapper">
        <div class="mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-[rgb(246,81,119)]">Danh Sách Danh Mục Đã Xóa</h2>
                </div>
            ...
            <table class="w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th class="border border-gray-300 p-3 font-semibold text-[rgb(246,81,119)] text-lg">Tên danh mục</th>
                    ...
                    @foreach ($list as $item)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="border border-gray-300 p-3 text-center text-[rgb(246,81,119)]">
                                ...
                                <form action="{{ route('category.destroy', ['category' => $item->id]) }}" class="inline" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button>
